...
colors  = [];
 ...
 colors{1}=pcolor.red  ;
 colors{2}=pcolor.crimson;
 colors{3}=pcolor.orange3 ;   
 colors{4}=pcolor.blue; 
 colors{5}=pcolor.pink;
 colors{6}=pcolor.black ;
 colors{7}=pcolor.gray;
 colors{8}=pcolor.yellow ;
 colors{9}=pcolor.green;
 colors{10}=pcolor.purple;
%  colors{9}=pcolor.;
